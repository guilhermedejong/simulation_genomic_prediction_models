...
output$Hybrid_var[year] = sum(2*p_bar*q_bar*(1 + Fhyb)*(a + (1 - Fhyb)/(1 + Fhyb)*(q_bar - p_bar)*d)^2, na.rm = TRUE) + 
  sum(4*p_bar*q_bar*((1 - Fhyb)/(1 + Fhyb))*(p_bar + Fhyb*q_bar)*(q_bar + Fhyb*p_bar)*(d^2), na.rm = TRUE)
