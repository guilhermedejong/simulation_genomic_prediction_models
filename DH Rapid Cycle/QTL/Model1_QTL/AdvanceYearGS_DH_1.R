...
MaleInbredYT2 = setEBV(MaleInbredYT2, gsModelM)
FemaleInbredYT2 = setEBV(FemaleInbredYT2, gsModelF)
...
MaleInbredYT1 = setEBV(MaleInbredYT1, gsModelM)
FemaleInbredYT1 = setEBV(FemaleInbredYT1, gsModelF)
