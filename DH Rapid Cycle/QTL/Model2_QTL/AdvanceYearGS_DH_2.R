...
MaleInbredYT2 = setEBV(MaleInbredYT2, gsModel)
FemaleInbredYT2 = setEBV(FemaleInbredYT2, gsModel)
...
MaleInbredYT1 = setEBV(MaleInbredYT1, gsModel)
FemaleInbredYT1 = setEBV(FemaleInbredYT1, gsModel)
