...
MaleInbredYT2 = setEBV(MaleInbredYT2, gsModel, value = "male")
FemaleInbredYT2 = setEBV(FemaleInbredYT2, gsModel, value = "female")
...
MaleInbredYT1 = setEBV(MaleInbredYT1, gsModel, value = "male")
FemaleInbredYT1 = setEBV(FemaleInbredYT1, gsModel, value = "female")
...
MaleDH = setEBV(MaleDH, gsModel, value = "male")
FemaleDH = setEBV(FemaleDH, gsModel, value = "female")
