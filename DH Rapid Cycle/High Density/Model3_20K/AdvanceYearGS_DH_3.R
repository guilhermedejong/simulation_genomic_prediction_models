...
MaleInbredYT2 = setEBV(MaleInbredYT2, gsModel, value = "bv", targetPop = FemaleInbredYT2)
FemaleInbredYT2 = setEBV(FemaleInbredYT2, gsModel, value = "bv", targetPop = MaleInbredYT2)
...
MaleInbredYT1 = setEBV(MaleInbredYT1, gsModel, value = "bv", targetPop = FemaleInbredYT1)
FemaleInbredYT1 = setEBV(FemaleInbredYT1, gsModel, value = "bv", targetPop = MaleInbredYT1)
